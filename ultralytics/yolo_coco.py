...
classes = ['naval', 'Merchant', 'dock', 'other_vessel']

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='ship/data_origin/test/images',type=str, help="path of images")
parser.add_argument('--label_path', default='ship/data_origin/test/labels',type=str, help="path of labels .txt")
parser.add_argument('--category_start', default=1, type=int, choices=[0, 1],
                    help='category id start index for COCO json')
...
def yolo2coco(arg):
    ...
    start_idx = arg.category_start

    for i, cls in enumerate(classes, start_idx):
