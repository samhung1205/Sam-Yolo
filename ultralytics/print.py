...
def select_device(device='', batch_size=0, newline=True):
    ...
    s = f'YOLO 🚀 {file_date()} Python-{platform.python_version()} torch-{torch.__version__} '
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='ultralytics/cfg/models/26/yolo26.yaml', help='model.yaml')
    ...
    if opt.line_profile:  # profile layer by layer
        ...
        results = profile_ops(input=im, ops=[model], n=3)
