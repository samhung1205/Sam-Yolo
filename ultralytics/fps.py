...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Test YOLO26 model performance.")
    parser.add_argument('--weights', type=str, default='yolo26m.pt', help='trained weights path')
